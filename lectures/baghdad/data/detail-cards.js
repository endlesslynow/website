...
var DETAIL_CARDS = {
    ...
    "al-mansur": {
        ...
        content: [
            ...
            "There are several key reasons why the inheritance he left to his son al-Mahdi triggered the city's golden age:",
            "Unprecedented Wealth and Economic Power: Because Mansur was relentlessly frugal—earning him the nickname \"Father of Pennies\"—he left behind an astonishing 14 million gold dinars and 600 million silver dirhams (roughly 2,640 metric tons of silver) upon his death. Combined with Baghdad's strategic location on the Tigris and Euphrates rivers, the city rapidly became an unrivalled global trading emporium that generated massive tax revenues from across the empire.",
            ...
            "Al-Mahdi's Cultural Awakening: Upon inheriting this immense wealth, al-Mahdi—who was as generous as his father had been mean—redirected the empire's focus toward the finer things in life. He heavily patronized poetry, music, and literary salons, and he expanded Baghdad by building the glittering, palace-filled district of Rusafa on the east bank of the Tigris.",
            "Setting the Stage for Harun al-Rashid: Mansur's disciplined state-building and Mahdi's cultural investments directly paved the way for the reign of Harun al-Rashid (786–809). This incredibly stable foundation allowed Harun to gather a brilliant court of scholars, fund the translation of classical texts, and usher in a period of such extraordinary prosperity and scientific discovery that it was famously dubbed \"the honeymoon\".",
    ...
    "many-names": {
        ...
        content: [
            ...
            "When the caliph Al-Mansur officially founded his new circular capital there in 762 AD, he had a very personal idea of what it should be called: Madinat al Mansur (the City of Mansur). However, this self-aggrandizing title completely failed to catch on with the public.",
    ...
    "baghdad-canals": {
        ...
        content: [
            ...
            "The Karkhaya Canal and Branches: Branching off the Isa Canal, waterways like the Karkhaya, Dajaj (Fowls), Bazzazin (clothes-merchants), and Tabik canals defined the commercial geography of the Karkh district. Different trades, such as coppersmiths, poulterers, soap-makers, and wholesale fruit sellers, congregated at specific wharves and unloading points along their banks.",
            "The Nahrawan Canal: An incredibly massive waterway measuring 200 miles long and a quarter of a mile wide. It was breached during a military campaign and never properly repaired, becoming partially silted up over time.",
            ...
            "Weaponization, Flooding, and Destruction: While the canals brought life and commerce to Baghdad, they also presented immense risks. In 940 AD, a dam breach at the head of the Isa Canal triggered a great flood that left heavily affected Baghdadis homeless for two years.",
    ...
    "barmakids": {
        ...
        content: [
            ...
            "The key figures of the dynasty included Khalid ibn Barmak, who served as vizier to Baghdad's founder, Al-Mansur; his son Yahya, who acted as a father figure and vizier with full executive authority for Harun al-Rashid; and Yahya's sons Jafar and Fadl.",
    ...
    "jafar-barmakid": {
        ...
        content: [
            ...
            "The Scandalous Legend: Historians like Tabari and Masudi suggest Harun arranged a \"paper marriage\" between Jafar and his sister, Abbasa, simply so she could respectably attend their private drinking parties. Harun gave strict orders that the marriage was never to be consummated, but the two ultimately slept together, and Abbasa secretly had a baby, prompting Harun's wrath.",
    ...
    "return-samarra": {
        ...
        content: [
            ...
            "The Illusion of Prestige vs. The Loss of Real Power While this extravagant palace-building made Baghdad \"a sight to behold\" and restored the physical splendor of the caliphate, it masked a grim political reality: the unchallenged imperial power of the early Abbasids was gone forever.",
    ...
    "byzantine-reception": {
        ...
        content: [
            ...
            "The Animals: In the caliph's Park of the Wild Beasts, the envoys were confronted by four elephants draped in peacock-silk brocade (complete with fire-throwers mounted on their backs) and a hundred chained lions handled by keepers.",
    ...
    "historys-greatest-mistake": {
        ...
        content: [
            ...
            "The letter then pivoted to specific demands. Hulagu ordered Al-Musta'sim to tear down the city ramparts and fill in the moats, to come to Hulagu in person, or at minimum to send his three highest ministers: the vizier Ibn al-Alqami, the general Sulaymanshah, and the Dawatdar. These three were to deliver Hulagu's terms face to face.",
            ...
            "On February 7 they came out again. Hulagu sent envoys back into the city to bring Sulaymanshah and the Dawatdar out personally. He sent a decree and a Mongol paiza (a tablet of authority) and told the caliph that he was free to come out or not, as he wished, but that the Mongol troops would remain on the walls until the demanded officials emerged.",
    ...
    "safavids": {
        ...
        content: [
            ...
            "The Safavids hold profound historical significance because they successfully united Persia under native Persian rule for the first time in 850 years—ending centuries of domination by Arab caliphs, Turkish sultans, and Mongol khans—and formally established the Shia faith as the official state religion.",
            ...
            "This militant promotion of Shia Islam put the Safavid Empire on a collision course with the neighboring Sunni Ottoman Empire, sparking a fierce and enduring geopolitical rivalry. Key events in this conflict included:",
            "The Battle of Chaldiran (1514): The Ottoman Sultan Selim the Grim, having already massacred tens of thousands of Shia within his own borders, routed Shah Ismail's heavily outnumbered army, dealing a psychological blow so severe that Ismail never took to the battlefield again.",
            "The Struggle for Baghdad: The city became a focal point of their rivalry, changing hands multiple times. The Ottomans captured Baghdad in 1534 under Suleyman the Magnificent, but Safavid rulers continually sought to undermine them. For instance, Shah Abbas I successfully recaptured Baghdad for the Safavids in 1623 through a secret pact, resulting in a horrific massacre and enslavement of thousands of the city's Sunni inhabitants.",
